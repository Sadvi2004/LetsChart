                    ...
                    <div className='space-y-6'>
                        <div className='flex flex-col items-center'>
                            <div className='relative group'>
                                <img src={preview || user?.profilePicture} alt="profilePicture" className='w-52 h-52 rounded-full mb-2 object-cover' />
                                <label htmlFor='profileUpload' className='absolute inset-0 bg-black bg-opacity-50 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer'>
                        ...
                        <div className={`relative p-4 ${theme === 'dark' ? "bg-gray-800" : "bg-white"} shadow-sm rounded`}>
                            <label htmlFor="name" className='block text-sm font-medium mb-1 text-gray-500 text-start'>
                                Your Name
                            </label>
                            <div className='flex items-center'>
                                {isEditingName ? (
                                    <input id="name" type='text' value={name} onChange={(e) => setName(e.target.value)} className={`w-full px-3 py-3 border rounded-md focus:outline-none focus-ring-2 focus:ring-green-500 ${theme === 'dark' ? "bg-gray-700 text-white" : "bg-white text-black"}`} />
                                ) : (
                        ...
                        <div className={`relative p-4 ${theme === 'dark' ? "bg-gray-800" : "bg-white"} shadow-sm rounded`}>
                            ...
                            <div className='flex items-center'>
                                {isEditingAbout ? (
                                    <input id="about" type='text' value={about} onChange={(e) => setAbout(e.target.value)} className={`w-full px-3 py-3 border rounded-md focus:outline-none focus-ring-2 focus:ring-green-500 ${theme === 'dark' ? "bg-gray-700 text-white" : "bg-white text-black"}`} />
                                ) : (
                                    <span className='w-full px-3 py-2'>
                                        {about}
                                    </span>
